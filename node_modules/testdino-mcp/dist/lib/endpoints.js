...
export const endpoints = {
     ...
     */
    createManualTestCase: (projectId) => {
        const baseUrl = getBaseUrl();
     ...
     */
    updateManualTestCase: (projectId, caseId) => {
        const baseUrl = getBaseUrl();
        return `${baseUrl}/api/mcp/manual-tests/${projectId}/test-cases/${caseId}`;
    },
    /**
     ...
     */
    createManualTestSuite: (projectId) => {
        const baseUrl = getBaseUrl();
     ...
     */
    updateRelease: (projectId, releaseId) => {
        const baseUrl = getBaseUrl();
        return `${baseUrl}/api/mcp/releases/${projectId}/${releaseId}`;
    },
    // ─── Manual Runs ───────────────────────────────────────────────────────────
     ...
     */
    updateManualRun: (projectId, runId) => {
        const baseUrl = getBaseUrl();
        return `${baseUrl}/api/mcp/manual-runs/${projectId}/${runId}`;
    },
    /**
     ...
     */
    updateRunTestCase: (projectId, runId, rtcRef) => {
        const baseUrl = getBaseUrl();
