...
export const updateManualRunTool = {
    ...
    inputSchema: {
        ...
        properties: {
            ...
            updates: {
                type: "object",
                description: "Fields to update: name, note, environment, releaseId, state, forecast, tags, linkedIssues, attachments, links, selectionMode.",
            },
        },
        required: ["projectId", "runId", "updates"],
    },
};
export async function handleUpdateManualRun(args) {
...
//# sourceMappingURL=update-manual-run.js.map