...
export const listTestRunsTool = {
    ...
    inputSchema: {
        ...
        properties: {
            ...
            by_time_interval: {
                type: "string",
                description: "Filter by time interval. Supports: 'Latest' (most recent, no time filter), '1h' (last hour), '2h' (last 2 hours), '5h' (last 5 hours), '12h' (last 12 hours), '1d' (last day), '3d' (last 3 days), '5d' (last 5 days), 'weekly' (last 7 days), 'monthly' (last 30 days), 'last 1 hour', 'last day', 'last 5 days', or '2024-01-01,2024-01-31' (date range).",
            },
            by_author: {
                type: "string",
            ...
            by_status: {
                ...
                description: "Filter by run status: 'passed', 'failed', 'interrupted', 'incomplete', or 'running'.",
            },
            by_test_case_tags: {
                type: "string",
                description: "Comma-separated test case tags contained in the run (exact match, include the '@' prefix if the tag has one, e.g. '@critical').",
            },
            search: {
                type: "string",
                description: "Search run commit messages, or match an exact run counter when the value is numeric.",
            },
            sort: {
                type: "string",
                enum: ["counter_desc", "counter_asc", "duration_asc", "duration_desc"],
                description: "Sort order for the run list: 'counter_desc' (newest first, default), 'counter_asc', 'duration_asc', or 'duration_desc'.",
            },
            limit: {
                type: "number",
