...
export const createManualTestSuiteTool = {
    ...
    description: "Create a new test suite folder to organize test cases. Use this to create a logical grouping for related test cases. Suites can be nested by providing a parentSuiteId.",
    inputSchema: {
        type: "object",
        properties: {
            projectId: {
...
export async function handleCreateManualTestSuite(args) {
...
//# sourceMappingURL=create-manual-test-suite.js.map