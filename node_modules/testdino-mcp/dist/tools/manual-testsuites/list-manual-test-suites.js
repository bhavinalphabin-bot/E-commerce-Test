...
export const listManualTestSuitesTool = {
    ...
    description: "List the test suite hierarchy to help users find suiteIds for test case creation. Use this to navigate the test suite structure and understand test organization.",
    inputSchema: {
        type: "object",
        properties: {
            projectId: {
...
export async function handleListManualTestSuites(args) {
...
//# sourceMappingURL=list-manual-test-suites.js.map