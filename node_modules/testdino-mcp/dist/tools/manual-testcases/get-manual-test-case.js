...
export const getManualTestCaseTool = {
    ...
    description: "Retrieve detailed information of a single manual test case, including steps, custom fields, preconditions, and all metadata. " +
...
export async function handleGetManualTestCase(args) {
...
//# sourceMappingURL=get-manual-test-case.js.map