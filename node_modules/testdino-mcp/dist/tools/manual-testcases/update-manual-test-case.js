...
import { processAttachments, processStepAttachments, } from "../../lib/file-utils.js";
export const updateManualTestCaseTool = {
    name: "update_manual_test_case",
    description: "Update an existing manual test case. Use this to modify test case details, steps, status, priority, or any other fields. Provide only the fields you want to update in the updates object. " +
    ...
    inputSchema: {
        ...
        properties: {
            ...
            updates: {
                type: "object",
                description: "Object containing the fields to update. Can include: title (or name), description, steps, status, priority, severity, type, layer, behavior, preconditions, postconditions, automationStatus, tags, flags, attachments, customFields, etc.",
                properties: {
                    name: {
                        type: "string",
                        description: "Updated test case title (or name). `title` is the rename-safe primary field; `name` is accepted as an alias.",
                    },
                    description: {
                        type: "string",
                    ...
                    steps: {
                        type: "array",
                        description: "Updated test steps array. For Classic format: action, expectedResult, and optional data. For Gherkin format: event and stepDescription. Each top-level step can include attachments as URLs or local file paths.",
                        items: {
                            type: "object",
                            oneOf: [
                                {
...
export async function handleUpdateManualTestCase(args) {
    ...
    try {
        ...
        if (processedUpdates.attachments?.add) {
            processedUpdates.attachments.add = processAttachments(processedUpdates.attachments.add);
        }
...
//# sourceMappingURL=update-manual-test-case.js.map