...
export const createManualTestCaseTool = {
    ...
    description: "Create a new manual test case. Use this to document new test scenarios, features, or requirements. Supports adding test steps, preconditions, postconditions, and metadata like priority, severity, and type.",
    inputSchema: {
        type: "object",
        properties: {
            projectId: {
            ...
            steps: {
                type: "array",
                description: "Array of test steps. For Classic format: action, expectedResult, and optional data. For Gherkin format: event and stepDescription. Each top-level step can include attachments as URLs or local file paths.",
                items: {
                    type: "object",
                    oneOf: [
                        {
...
//# sourceMappingURL=create-manual-test-case.js.map