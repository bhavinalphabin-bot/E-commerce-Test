...
export const listManualTestCasesTool = {
    ...
    description: "Search and list manual test cases with filtering capabilities. Use this to find specific manual test cases for QA testing, auditing, or test case management. Supports filtering by project, time, suite, status, priority, severity, type, layer, behavior, automation status, and tags.",
    inputSchema: {
        type: "object",
        properties: {
            projectId: {
            ...
            search: {
                type: "string",
                description: "Search term to match against title or caseId. Example: 'login' or 'TC-123'.",
            },
            suiteId: {
                type: "string",
            ...
            tags: {
                type: "string",
                description: "Filter by tags. Can be a single tag or comma-separated tags. Example: 'smoke' or 'smoke,regression,login'.",
            },
            limit: {
                type: "number",
...
export async function handleListManualTestCases(args) {
...
//# sourceMappingURL=list-manual-test-cases.js.map