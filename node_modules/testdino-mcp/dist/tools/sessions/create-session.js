...
export const createSessionTool = {
    ...
    inputSchema: {
        ...
        properties: {
            ...
            state: {
                type: "string",
                description: "Workflow state (default 'new'). Either canonical ('under_review') or display ('Under review') form — server normalizes to lowercase+underscored so UI colors render correctly.",
            },
