...
export const updateSessionTool = {
    ...
    inputSchema: {
        ...
        properties: {
            ...
            updates: {
                type: "object",
                description: "Fields to update: name, mission, sessionType, config, environment, releaseId, assigneeUserId, state, estimate, tags, linkedIssues, attachments.",
            },
        },
        required: ["projectId", "sessionId", "updates"],
    },
};
export async function handleUpdateSession(args) {
