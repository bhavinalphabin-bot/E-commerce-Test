...
export const listSessionsTool = {
    name: "list_sessions",
    description: "Browse exploratory sessions for a project. Filter by status (active|closed), state, sessionType, assigneeUserId, release (releaseId), tags, or free-text search on name. Pass releaseId='none' for sessions not attached to a release. Default page size 25 (max 200).",
    inputSchema: {
        type: "object",
        properties: {
            ...
            state: {
                type: "string",
                description: "Workflow state. Either canonical ('under_review', 'done') or display ('Under review', 'Done') form — the server normalizes lowercase+underscored.",
            },
