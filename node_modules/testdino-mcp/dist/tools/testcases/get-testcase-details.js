...
export const getTestCaseDetailsTool = {
    ...
    inputSchema: {
        ...
        properties: {
            ...
            testcase_name: {
                type: "string",
                description: "Test case title (partial match, case-insensitive). Must be combined with testrun_id or counter when used alone. Example: 'Verify user can logout and login'.",
            },
            testcase_fulltitle: {
                type: "string",
...
export async function handleGetTestCaseDetails(args) {
    ...
    if (!hasTestCaseId && !hasSearchParam) {
        throw new Error("At least one of the following must be provided: 'testcase_id', 'testcase_name', 'testcase_fulltitle', 'by_error_message', or 'by_code_snippet'.");
    }
    try {
