export const AUDIT_CATEGORY_METADATA = {
    surface_level_tests: {
        ...
        description: "Tests only check page load or basic UI presence, not meaningful behavior.",
    },
    missing_validation: {
    ...
    stability_issues: {
        ...
        description: "Timing, waiting, shared-state, or order-dependent issues make tests unreliable.",
    },
    hard_to_maintain: {
        label: "Hard to Maintain",
        description: "Selectors, setup, naming, or structure make the suite difficult to update safely.",
    },
    coverage_gaps: {
        label: "Missing Scenarios",
        description: "Important cases like errors, empty states, mobile, or accessibility are not covered.",
    },
    organization_ownership: {
        label: "Organization & Ownership",
        description: "Grouping, tags, skips, or ownership signals are missing or unclear.",
    },
    setup_configuration: {
        label: "Setup & Configuration",
        description: "Project-level configuration weakens reliability, debugging, or consistency.",
    },
    duplication_overlap: {
        label: "Duplication & Overlap",
        description: "Multiple tests repeat or fragment the same flow instead of covering it cleanly.",
    },
    other: {
        label: "General Issues",
        description: "Issues that need follow-up or do not fit the main audit groups cleanly.",
    },
};
export const AUDIT_CATEGORY_CODES = Object.freeze(Object.keys(AUDIT_CATEGORY_METADATA));
export const DEFAULT_AUDIT_CATEGORY = "other";
function normalizeAuditCategoryKey(value) {
    return value
        .trim()
        .toLowerCase()
        .replace(/&/g, " and ")
...
export function normalizeAuditSubCategory(value) {
    if (typeof value !== "string")
        return "";
    return value
        .trim()
...
//# sourceMappingURL=audit-categories.js.map