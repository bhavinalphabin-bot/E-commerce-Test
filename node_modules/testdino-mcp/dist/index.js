...
// Sessions
listSessionsTool, handleListSessions, getSessionTool, handleGetSession, createSessionTool, handleCreateSession, updateSessionTool, handleUpdateSession, } from "./tools/index.js";
...
async function main() {
    ...
    server.setRequestHandler(CallToolRequestSchema, async (request) => {
        ...
        if (name === "test_audit") {
            return await handleTestAudit(args);
        }
